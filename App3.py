...
# Load models
models = {}
models['Xception'] = load_model("model/forgery_detection_model_Xception.h5")
#models['Inception'] = load_model("model/forgery_detection_model_InceptionV3.keras")
...
def index():
    if request.method == 'POST':
        ...
        if file:
            ...
            return render_template('index2.html', predictions=predictions, img=img)
    return render_template('index2.html', predictions=None, file_path=None)
